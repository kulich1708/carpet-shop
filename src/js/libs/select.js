...
class SelectConstructor {
	...
	getSelectTitleValue(selectItem, originalSelect) {
		...
		if (originalSelect.hasAttribute('data-search')) {
			...
			return `<div class="${this.selectClasses.classSelectTitle} ${this.selectClasses.classSelectTitle}_search"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}"><input autocomplete="off" type="text" placeholder="${selectTitleValue}" data-placeholder="${selectTitleValue}" class="${this.selectClasses.classSelectInput} input_border ${customClass}"></span></div>`;
		} else {
			// Выводим текстовое значение
			let result = ''
			if (originalSelect.hasAttribute('data-icon-class')) result = `<button type="button" class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span><i class="${originalSelect.getAttribute('data-icon-class')}"></i></button>`
			else result = `<button type="button" class="${this.selectClasses.classSelectTitle}"><span${pseudoAttribute} class="${this.selectClasses.classSelectValue}${pseudoAttributeClass}"><span class="${this.selectClasses.classSelectContent}${customClass}">${selectTitleValue}</span></span></button>`
			return result;
		}
	}
